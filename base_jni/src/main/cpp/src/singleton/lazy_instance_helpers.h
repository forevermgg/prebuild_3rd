...
#ifndef FOREVER_LAZY_INSTANCE_HELPERS_H_
#define FOREVER_LAZY_INSTANCE_HELPERS_H_
...
void CompleteLazyInstance(std::atomic<uintptr_t>& state, uintptr_t new_instance,
                          void (*destructor)(void*), void* destructor_arg);
...
Type* GetOrCreateLazyPointer(std::atomic<uintptr_t>& state,
                             Type* (*creator_func)(void*), void* creator_arg,
                             void (*destructor)(void*), void* destructor_arg) {
  FOREVER_DCHECK(creator_func);
  ...
  if (!(instance & kLazyInstanceCreatedMask)) {
    if (INTERNAL::NeedsLazyInstance(state)) {
      ...
      FOREVER_DCHECK(instance & kLazyInstanceCreatedMask);
    }
  }
...
#endif  // FOREVER_LAZY_INSTANCE_HELPERS_H_
